 ...
 */
window.FIRMA = {
 "corregirBoton": "Corriger cette réponse",
 "corregirQue": "Écrivez ici la réponse que vous attendiez…",
 "corregirMotivo": "Pourquoi c'était faux (facultatif)",
 "corregirFirmar": "Signer la correction",
 "corregirNoViaja": "Signé et conservé sur VOTRE appareil. Rien ne part seul : pour le remettre, vous l'exportez en fichier.",
 "corregirGuardado": "Signé et conservé ici. Rien n'est sorti de votre appareil.",
 "corregirFallo": "Signature impossible",
 "idEntrar": "Créer une identité",
 "idAviso": "Une clé est générée dans votre navigateur. Ni exportable ni copiable : si vous effacez les données du site, cette identité est perdue sans recours. Aucun mot de passe à oublier, aucun serveur qui la garde.",
 "idClave": "Voir mon empreinte",
 "idFallo": "NO_DATA — l'identité n'a pas pu être créée :",
 "idPerfil": "Mon profil",
 "idPublica": "Clé publique :",
 "exp": {
  "b": "Exporter les corrections",
  "n": "corrections enregistrées",
