 ...
 */
window.FIRMA = {
 "corregirBoton": "Correct this answer",
 "corregirQue": "Write the answer you expected…",
 "corregirMotivo": "Why it was wrong (optional)",
 "corregirFirmar": "Sign the correction",
 "corregirNoViaja": "It is signed and stored on YOUR device. It never travels alone: to hand it over, you export it to a file.",
 "corregirGuardado": "Signed and stored here. Nothing left your device.",
 "corregirFallo": "Could not sign",
 "idEntrar": "Create identity",
 "idAviso": "A key is generated in your browser. It cannot be exported or copied to another device: if you clear the site data, this identity is lost and there is no way to recover it. There is no password to forget and no server holding it.",
 "idClave": "See my fingerprint",
 "idFallo": "NO_DATA — the identity could not be created:",
 "idPerfil": "My profile",
 "idPublica": "Public key:",
 "exp": {
  "b": "Export corrections",
  "n": "saved corrections",
