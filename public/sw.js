...
const HUB = ['/hub.json', '/hub-textos.json',
             ...
             '/assets/instalar-descargas.js', '/assets/widget.css', '/assets/puertas.css', '/assets/escribir.css', '/assets/placa.css', '/medidas.json', '/assets/medidas.js', '/nav.json', '/assets/nav.js', '/assets/selector-modelo.js', '/cerebros.json', '/assets/logos-models/preceptor.svg', '/assets/logos-models/qwen.svg', '/assets/logos-models/mistral.svg', '/assets/cabezal.css', '/assets/esquina.css', '/assets/esquina-cuenta.css', '/assets/mandos.css', '/assets/panel.css', '/assets/nubes.css', '/assets/senal.css', '/assets/senal.js',
             '/assets/hub.js',
