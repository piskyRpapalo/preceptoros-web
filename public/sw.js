 ...
 */
const VERSION = 'preceptoros-2026-10-s';
...
const HUB = ['/hub.json', '/hub-textos.json',
             ...
             '/assets/instalar-descargas.js', '/assets/widget.css', '/assets/puertas.css', '/assets/escribir.css', '/assets/placa.css', '/medidas.json', '/assets/medidas.js', '/nav.json', '/assets/nav.js', '/assets/cabezal.css', '/assets/esquina.css', '/assets/panel.css', '/assets/nubes.css', '/assets/senal.css', '/assets/senal.js',
             '/assets/hub.js',
